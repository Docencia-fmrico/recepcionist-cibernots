...
#ifndef BTS__INTRODUCEGUEST_HPP_
#define BTS__INTRODUCEGUEST_HPP_
...
class IntroduceGuest : public BT::ActionNodeBase
{
public:
  explicit IntroduceGuest(
  ...
  {
    return {BT::InputPort<std_msgs::msg::String>("name_")};
  }
