...
#ifndef TF2_DETECTOR__OBJECTDETECTORIMPROVEDNODE_HPP_
#define TF2_DETECTOR__OBJECTDETECTORIMPROVEDNODE_HPP_
...
class ObjectDetectorImprovedNode : public rclcpp::Node
{
public:
  ObjectDetectorImprovedNode();
